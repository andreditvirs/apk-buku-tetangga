...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, ModelBukuKeranjang> expandableListDetalles;

    public CustomExpandableListAdapter(Context context,
                                       List<String> listTitulo,
                                       HashMap<String, ModelBukuKeranjang> expandableListDetalles) {
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final ModelBukuKeranjang modelBukuKeranjang = (ModelBukuKeranjang) getChild(groupPosition, childPosition);
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), modelBukuKeranjang.getImg());
        ...
        layoutLlamar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "Llamamos a: "
                        + modelBukuKeranjang.getNumero(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        layoutMensaje.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "Mensaje para: "
                        + modelBukuKeranjang.getCorreo(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        layoutInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(v.getContext(), "Info de: "
                        ...
                        + modelBukuKeranjang.getDireccion(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        ModelBukuKeranjang modelBukuKeranjang = (ModelBukuKeranjang) getChild(groupPosition,0);
        ...
        txtNumero.setText(modelBukuKeranjang.getNumero());
