...
public class GridRakBukuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_grid_rak_buku, container, false);
        ...
        call.enqueue(new Callback<List<Spacecraft>>() {
            ...
            public void onResponse(Call<List<Spacecraft>> call, Response<List<Spacecraft>> response) {
                ...
                mGridView = rootView.findViewById(R.id.mGridView);
                adapter = new GridViewAdapter(getActivity(),response.body());
