package com.example.buku_tetangga.activities;
...
import com.example.buku_tetangga.adapters.RecyclerViewAdapter;
...
public class SearchAddBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_add_book);
        ...
        final JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, key.toString(), null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        String title ="";
                        String author ="";
                        String publishedDate = "Tidak Tersedia";
                        String description = "Tidak Ada Deskripsi";
                        int pageCount = 1000;
                        String categories = "Tidak Ada Kategori";
                        String buy ="";

                        String price = "Tidak Dijual";
                        try {
                            ...
                            for (int i = 0 ; i< items.length() ;i++){
                                ...
                                mAdapter = new RecyclerViewAdapter(SearchAddBookActivity.this , mBooks);
